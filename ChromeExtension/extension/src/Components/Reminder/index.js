...
export default function Reminder() {
    ...
    return (
        <div id="showReminding" onClick={handleClick} style={{ fontFamily: 'ZCOOL KuaiLe', cursive: "true" }}>
            <div style={{ margin: "10px", lineHeight: "25px" }}>{word === "" ? reminder[getRandomInt(reminder.length)] : word}</div>
